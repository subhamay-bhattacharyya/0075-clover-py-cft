![](https://img.shields.io/github/commit-activity/t/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/last-commit/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/release-date/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/repo-size/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/directory-file-count/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/actions/workflow/status/subhamay-bhattacharyya/0075-clover-py-cft/deploy-stack.yaml)&nbsp;![](https://img.shields.io/bitbucket/issues/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/languages/top/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/github/commit-activity/m/subhamay-bhattacharyya/0075-clover-py-cft)&nbsp;![](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/bsubhamay/b21a193b71079cfd71034ff303e7cae9/raw/0075-clover-py-cft.json)



# Project Clover: Manage a Container Task (Amazon ECS, Amazon SNS)

Step Function demo pattern to run an ECS task and send SNS notification on success or failure.

## Description

This sample project demonstrates how to run an AWS ECS (EC2 Launch Type) task, and then send an Amazon SNS notification based on whether that job succeeds or fails. Deploying this sample project will create an AWS Step Functions state machine, a Fargate cluster, and an Amazon SNS topic.
...
```mermaid
flowchart TD
    A((Start)) --> B[Run a ECS Task]
    B[Run a ECS Task] --> C[Wait for X Seconds]
    C[Wait for X Seconds] --> D[Notify Success]
    C[Wait for X Seconds] --> E[Notify Failure]
    D[Notify Success] --> F((End))
    E[Notify Failure] --> F((End))
